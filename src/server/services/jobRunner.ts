...
import { createImportJob, getImportJob, updateImportJob } from "../db.ts";
...
export function startImportJob(db: Database, sourcePath: string): number {
...
export function startReindexJob(db: Database): number {
